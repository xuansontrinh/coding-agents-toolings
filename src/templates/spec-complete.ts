...
2. **Verify completeness**: Read the spec and tasks files, then check:
...
3. **Write a completion summary**: Append to the spec file:
...
- **Be honest in the summary**: If the implementation diverged from the spec, document why. This is valuable context for anyone revisiting the work.
